...
<div class="login-box box1">
  	...
  	<div class="well well-sm center primarycolor heaf">
  		<h3 class="center">MEDICAL STORE MS | Login</h3>
  	</div>
  ...
  <div class="well well-sm inside">
    ...
    <div class="form-group">
        <?= Html::submitButton('Sign In', ['class' => 'btn primarycolor text-white btn-block btn-flat', 'id' => 'login-button','aria-hidden'=>"true"]) ?>
    </div>
