...
" class='img-circle' style='width: 120px;height: 120px'></div>
    ...
    <?php if($isAdmin){?><p>Administrator<p>
       <?php } else{?><p class="text-white">Drug Seller<p><?php }?>
        </div>
  </div>
  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
       ...
       <?php if($isAdmin ):?>
        <li><i class="fa fa-upload fa-fw text-success"></i> <?= Html:: a("Help",['/miamala/helpers'],['class' => 'btn btn-primary half-5']) ?></li>
        <?php endif;?>
      </ul>
    </div>
  </div>
  ...
  <div class="item">
      ...
      <?php if($isAdmin):?>
       ...
       <li><i class="fa fa-picture-o  fa-fw text-gado"></i> <?= Html:: a("Profile Settings",['/miamala/profile'],['class' => 'btn btn-primary half-5']) ?></li>
        ...
        <li ><i class="fa fa-sign-out fa-fw text-white"></i> <?= Html:: a("Sign Out",['miamala/logout'],['class' => 'btn btn-primary half-5']) ?></li>
      </ul>
    </div>
</div>
<div class="marginLeft back">
