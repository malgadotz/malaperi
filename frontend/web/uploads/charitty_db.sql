...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 13, 2021 at 09:26 AM
...
(101, '0000-00-00', '00:00:00', 'uhgh', '35465789809-', '', 10000, 'guoegveivhvqo', 117, 6),
(102, '0000-00-00', '00:00:00', 'TZ S', '4565768790-', '', 121235, 'hdbvi', 117, 6);
...
(6, 'thedonor', '', 'thedonor@gmail.com', '$2y$10$NJ9VMdLArf87NymDmLCWceIL.kipHsNYALIjN.mlv88mltO38ACPm', 'zimbabwe', 'dodomaa', '1626026165profil.PNG'),
(10, 'herode', '', 'herode@gmail.com', '$2y$10$wJtl2Pyh80sCagTv6gn7QeQS3MM9X7XtWTiayr0TeGJ8hCUKg8ru2', '', '', 'user.png'),
(11, 'serve', '', 'girls@gmail.comm', '$2y$10$Tl6R1twcLF/wFiBi7HjqgeHMj.MPdKjjSCt1sZktybZW8aoz71T2C', 'Peru', 'mbeya', 'user.png'),
...
(19, 'khalid', '', 'thewiner@gmail.com', '$2y$10$zMOZID01F1cQKwU0BSxpgubI3T7BAJOeOAtYnREYAsu.m57o.wIFG', 'Tanzania', 'Dar es salaamm', 'user.png'),
(20, 'malgado', '', 'malgado@gmail.com', '$2y$10$aBvLPdedq3uXnT.H0k9t/ODisWTaTIzHoxEekmUH4.lDCcs69YHkm', 'Tanzania', 'arusha', 'user.png'),
(21, 'Peter', NULL, 'iamqhp@gmail.com', '', 'Tanzania', 'Tanga', NULL),
(22, 'charityy', NULL, 'adm@gmail.com', '', 'Kenya', 'Nairobi', NULL),
(23, 'Lameck', NULL, 'sdfghj@gmail.com', '', 'Malawi', 'Mwanza', NULL),
(24, 'Lameck', NULL, 'sdfghj@gmail.com', '', 'Malawi', 'Mwanza', NULL);
...
(32, 'TANZANIA', 'Tanzania', 'DAr', 'ashleypeterhp@outlook.com', '77777', '5678965', 'active', 2147483647, 'e'),
(33, '', NULL, 'DOM', '', '', '5678965', 'active', 2147483647, NULL);
...
--
ALTER TABLE `ngo`
  MODIFY `NGO_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
