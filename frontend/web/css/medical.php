  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="inventeriesadm.php"><li><i class="fa fa-circle-o fa-fw"></i> Inventeries</li></a>
...
<!--         <a href="newsell"><li><i class="fa fa-circle-o fa-fw"></i> New Sell</li></a> -->
        <a href="reportsadm.php"><li><i class="fa fa-circle-o fa-fw"></i> Report</li></a>
      </ul><
    </div>
  </div>
...
<div class="account" style="display: none;">
  ...
  ?>
    <a href="inventeriesadm.php?catId=<?php echo $row['id'] ?>"><div class="box2 col-md-3">
     <div class="center">
      <img src="photo/<?php echo $row['pic'] ?>" style="width: 155px;height: 122px;" class='img-thumbnail'>
    </div>
      <hr style="margin: 7px;">
